#!/usr/bin/env python3
"""Project-local PermissionRequest command hook."""
...
def main() -> int:
    try:
        ...
        from smart_codex.codex_hook_adapter import handle_permission_request
        ...
        try:
            ...
            payload = {}
        response = handle_permission_request(payload)
